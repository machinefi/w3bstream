...
func (v *CurrentPublisher) WithAccountContext(ctx context.Context) (context.Context, error) {
	...
	if acc, err = account.GetBySFID(ctx, prj.AccountID); err != nil {
		return nil, err
	}
	return types.WithAccount(ctx, acc), nil
}

func (v *CurrentPublisher) WithStrategiesContextByChannelAndType(ctx context.Context, c, t string) (context.Context, error) {
	var (
		err error
