...
type HandleDataPush struct {
	...
	AuthInHeader string       `in:"header" name:"Authorization,omitempty" validate:"@string[1,]"`
	AuthInQuery  string       `in:"query" name:"authorization,omitempty" validate:"@string[1,]"`
	DataPushReqs DataPushReqs `in:"body"`
}

func (o *HandleDataPush) Path() string {
	return "/srv-applet-mgr/v0/event2/:channel"
}

func (o *HandleDataPush) Method() string {
	return "POST"
}
...
func (o *HandleDataPush) Do(ctx context.Context, cli kit.Client, metas ...kit.Metadata) kit.Result {
	ctx = metax.ContextWith(ctx, "operationID", "applet-mgr.HandleDataPush")
	return cli.Do(ctx, o, metas...)
}

func (o *HandleDataPush) InvokeContext(ctx context.Context, cli kit.Client, metas ...kit.Metadata) (*string, kit.Metadata, error) {
	rsp := new(string)
	meta, err := cli.Do(ctx, o, metas...).Into(rsp)
	return rsp, meta, err
}

func (o *HandleDataPush) Invoke(cli kit.Client, metas ...kit.Metadata) (*string, kit.Metadata, error) {
	return o.InvokeContext(context.Background(), cli, metas...)
}
