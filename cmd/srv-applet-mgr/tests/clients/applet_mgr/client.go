...
type Interface interface {
	...
	HandleDataPush(req *HandleDataPush, metas ...kit.Metadata) (*string, kit.Metadata, error)
...
func (c *Client) HandleDataPush(req *HandleDataPush, metas ...kit.Metadata) (*string, kit.Metadata, error) {
	return req.InvokeContext(c.Context(), c.Client, metas...)
}
