...
func ParseConfigTypeFromString(s string) (ConfigType, error) {
	...
	case "PROJECT_DATABASE":
		return CONFIG_TYPE__PROJECT_DATABASE, nil
	case "INSTANCE_CACHE":
...
func (v ConfigType) String() string {
	...
	case CONFIG_TYPE_UNKNOWN:
		return ""
	case CONFIG_TYPE__PROJECT_DATABASE:
...
func (v ConfigType) ConstValues() []enum.IntStringerEnum {
	return []enum.IntStringerEnum{CONFIG_TYPE__PROJECT_DATABASE, CONFIG_TYPE__INSTANCE_CACHE, CONFIG_TYPE__PROJECT_ENV}
}
