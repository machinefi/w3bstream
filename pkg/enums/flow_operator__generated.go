...
func ParseFlowOperatorFromString(s string) (FlowOperator, error) {
	...
	case "COUNT":
		return FLOW_OPERATOR__COUNT, nil
	}
}
...
func (v FlowOperator) ConstValues() []enum.IntStringerEnum {
	return []enum.IntStringerEnum{FLOW_OPERATOR__FILTER, FLOW_OPERATOR__MAP, FLOW_OPERATOR__FLATMAP, FLOW_OPERATOR__GROUP, FLOW_OPERATOR__COUNT}
}
