...
func (v Error) Key() string {
	...
	case TrafficRateLimitNotFound:
		return "TrafficRateLimitNotFound"
	case Conflict:
		return "Conflict"
	...
	case RateLimitConflict:
		return "RateLimitConflict"
...
func (v Error) Msg() string {
	...
	case TrafficRateLimitNotFound:
		return "Traffic RateLimit Not Found"
	case Conflict:
	...
	case RateLimitExceeded:
		return "RateLimit Exceeded Failed"
	case RateLimitKeyNotOk:
